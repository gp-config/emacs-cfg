;;; gmacs-blue-theme.el - an Emacs color theme by Geordie Powers // GeordieP @ github
...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))
  ...
  (gmacs-bg-primary "#28292e" nil)
  (gmacs-bg-primary-dark "#25262a")
  (gmacs-bg-primary-light "#373737")
  (gmacs-bg-primary-verydark "#22252a" nil)

  (gmacs-med-gray "#444a52")

  (gmacs-fg-primary "#999bae" nil)
  (gmacs-fg-primary-darker "#747477" nil)
  (gmacs-fg-primary-lighter "#ceced8" nil)
 ...
 ;; Evaluated Forms:
 (custom-theme-set-variables 'gmacs-blue
                             `(hl-paren-colors
                               '(,generic-green
                                 ,generic-red
                                 ,generic-red
...
(provide-theme 'gmacs-blue)
(provide 'gmacs-blue-theme)
