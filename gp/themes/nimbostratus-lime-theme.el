...
;;; nimbostratus-lime-theme.el --- Emacs theme with a dark background.
...
(setq theme_col1 "#a8d631")
;; col2 is for variable names
(setq theme_col2 "#cae682")

 (deftheme nimbostratus-lime)
...
(provide-theme 'nimbostratus-lime)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; nimbostratus-lime-theme.el ends here
