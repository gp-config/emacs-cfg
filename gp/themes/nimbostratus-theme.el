...
;;; nimbostratus-theme.el --- Emacs theme with a dark background.
...
;; MERCHANTABILITY or FITNESS FOR A PARTICULAR LIMEOSE. See the
...
;; (setq theme_col_text "#bababa")
(setq theme_col_text "#959595")
;; col1 is for function names, cursor color, etc
(setq theme_col1 "#cccccc")
;; col2 is for variable names
(setq theme_col2 "#cccccc")
;; cursor color
;; string col
(setq theme_string_col "#8191A1")
(setq theme_cursorcol theme_col1)
;; comments
(setq theme_commentcol "#616161")
;; warning/search current match highlight bg/matching brace bg
(setq theme_searchmatchcol_bg theme_col_text)
(setq theme_searchmatchcol_fg "#000000")

(setq theme_modeline_text_col theme_col_text)

 (deftheme nimbostratus)
 (let ((class '((class color) (min-colors 89)))
       ...
       (keyword theme_col2)
       (const   theme_col2)
       (comment theme_commentcol)
       (func    theme_col1)
       (cursorCol    theme_cursorcol)
       (str     theme_string_col)
       (type    theme_col2)
       (var     theme_col2)
...
(provide-theme 'nimbostratus)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; nimbostratus-theme.el ends here
