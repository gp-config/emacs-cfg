;;; gmacs-light-theme.el - an Emacs color theme by Geordie Powers // GeordieP @ github
...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))
  ...
  (gmacs-light-clr gmacs-fg-primary nil)
 ...
 ((default (:background gmacs-bg-primary :foreground gmacs-fg-primary))
  ...
  (mode-line (:box nil :foreground gmacs-accent-light :background gmacs-bg-primary-light))
  ...
  (trailing-whitespace (:background gmacs-light-clr))
  (escape-glyph (:foreground generic-cyan))
  (header-line (:background gmacs-bg-primary :foreground gmacs-light-clr :box nil :inherit nil))
  ...
  ;; evil ex
  (evil-ex-commands (:foreground gmacs-light-clr))
  ...
  (line-number-current-line (:foreground gmacs-light-clr :background gmacs-bg-primary))
  (linum (:foreground gmacs-med-gray))
  (linum-highlight-face (:foreground gmacs-light-clr :background gmacs-bg-primary))
  (linum-relative-current-face (:foreground gmacs-light-clr :background gmacs-bg-primary))
  ...
  (sp-show-pair-mismatch-face (:background gmacs-light-clr))

  ;; diff
  (diff-changed (:background nil :foreground gmacs-light-clr))
  ...
  ;; powerline
  (powerline-active0 (:foreground gmacs-light-clr :background gmacs-bg-primary))
  (powerline-active1 (:foreground gmacs-light-clr :background gmacs-med-gray))
  (powerline-active2 (:foreground gmacs-light-clr :background gmacs-grey))
  (powerline-inactive0 (:foreground gmacs-light-clr :background gmacs-bg-primary))
  (powerline-inactive1 (:foreground gmacs-light-clr :background gmacs-med-gray))
  (powerline-inactive2 (:foreground gmacs-light-clr :background gmacs-grey))
  (spaceline-python-venv (:foreground generic-purple)))

 ;; Evaluated Forms:
 (custom-theme-set-variables 'gmacs-light
                             `(hl-paren-colors
                               '(,generic-green
                                 ,generic-red
                                 ,generic-red
...
(provide-theme 'gmacs-light)
(provide 'gmacs-light-theme)
